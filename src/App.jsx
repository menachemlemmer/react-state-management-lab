  ...
  return (
    <>
      ...
      <ul className="flex flex-wrap justify-start">
        {team.length === 0 && (
          <p className="px-4 py-4">Pick some team members!</p>
        )}
        {team.map((fighter, index) => (
          <li
            className="mx-2 my-4 flex flex-col items-start gap-2 px-2 py-4"
            key={index}
          >
      ...
      <h2 className="px-4 py-4 text-2xl font-bold">Zombie Fighters</h2>
      <ul className="flex flex-wrap justify-start">
